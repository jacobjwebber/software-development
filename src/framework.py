...
def render_edit_band(loadedband):
           return render_template('editband.html', band=loadedband,  people=gamerules.troops, wizard=gamerules.wizard, apprentice=gamerules.apprentice, specs = gamerules.specialisms, skills = gamerules.skillsets, weaps = gamerules.weapon), httpcodes.OK
"""render_template(
                 'editband.html',
                 band=loadedband, 
                 people=gamerules.troops, 
